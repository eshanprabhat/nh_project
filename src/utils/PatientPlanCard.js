    ...
    <div className="patient-plan-container">
      <div className="plan-content-wrapper">
        ...
        <div className="plan-details-wrapper">
          ...
          <div className="patient-plan-card-content">
            <b>Policy Holders:-</b> <u>{patientNames.join(", ")}.</u>
          </div>
          <div className="patient-plan-card-content">
            <b>Total Amount Paid:-</b> Rs. {p.total_amount}
          </div>
          <div className="patient-plan-card-content">
            <b>Purchased On:-</b> {formattedDatePurchased}
          </div>
          <div className="patient-plan-card-content">
            <b>Expiry Date:-</b> {formattedDateExpiry}
          </div>
          <div className="patient-plan-card-content">
            <b>Order ID:-</b> {p.order_id}
          </div>
          <div className="patient-plan-card-content">
            <b>Payment ID:-</b> {p.payment_id}
          </div>
        </div>
      </div>
    </div>
